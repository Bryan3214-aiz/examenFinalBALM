<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="Contacto.aspx.cs" Inherits="examenFinalBALM.Contacto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card">
                <div class='background'>
                    <img src="img/Bryan2.jpg" alt="background" style="font-size: x-small"/>
                </div>
                <div class='content'>
                    <h1>Bryan Leiva Mejia</h1>
                    <p>
                        Ingeniero informatico, me gusta la musica, comer pizza y jugar volleyball. 
                    </p>
